...
*/
           // yazdir(urn1);
            //yazdir(urn2);
            Urun urn3 = new Urun();
            Console.Write("Lütfen Urun Kodunu Giriniz:");
...
/*
        ...
        private static void barkod(Urun urn)
        {
            if (urn.barkod_kodu == "1ADbX")
            {
                Urun urn1 = new Urun();
                urn1.fiyat = 5;
                urn1.tur = "Ciklet";
            ...
            else if (urn.barkod_kodu == "1ADSV")
            {
                ...
                Console.WriteLine("===========================");
                Console.WriteLine("Urun fiyati={0}", urn2.fiyat);
                Console.WriteLine("Urun tur={0}", urn2.tur);
                Console.WriteLine("Urun markasi={0}", urn2.marka);
                Console.WriteLine("Urun model={0}", urn2.model);
                Console.WriteLine("Urun uretim yili={0}", urn2.uretim_yili);
                Console.WriteLine("Urun barkod kodu={0}", urn2.barkod_kodu);
            }
